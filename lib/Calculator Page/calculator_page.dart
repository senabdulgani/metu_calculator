...
//       body: FutureBuilder(
//         future: FirebaseFirestore.instance.collection('merahba').doc('testverisi').get(),
...
//                 return Text('Firebase Bağlantısı Başarılı: ${data.toString()}');
//               }
//               return Text('Firebase Bağlantısı Başarısız');
//             },
//         // child: Stack(
...
//         //           ),
//         //           // Quiz notları
//         //           const Text('Quiz Notları', style: TextStyle(fontSize: 16)),
//         //           Row(
//         //             children: [
//         //               Expanded(
//         //                 child: TextField(
...
//         //           ),
//         //           // Writing notları
//         //           const Text('Writing Notları', style: TextStyle(fontSize: 16)),
//         //           Row(
//         //             children: [
//         //               Expanded(
//         //                 child: TextField(
